...
if __name__ == "__main__":
    ...
    # 1
    priors1 = [
        {'N1': 2, 'N2': 0, 'N3': 0, 'N4': 3, 'target': float(black_box_function(2, 0, 0, 3) + cost_function([2, 0, 0, 3]))},
        # Prior 1
    ...
    # 2
    priors2 = [
        {'N1': 0, 'N2': 1, 'N3': 1, 'N4': 3, 'target': black_box_function(0, 1, 1, 3) + cost_function([0, 1, 1, 3])},
        # Prior 1
        {'N1': 2, 'N2': 2, 'N3': 2, 'N4': 1, 'target': black_box_function(2, 2, 2, 1) + cost_function([2, 2, 2, 1])},
        # Prior 2
        {'N1': 3, 'N2': 0, 'N3': 0, 'N4': 2, 'target': black_box_function(3, 0, 0, 2) + cost_function([3, 0, 0, 2])},
        # Prior 3
        {'N1': 1, 'N2': 3, 'N3': 3, 'N4': 0, 'target': black_box_function(1, 3, 3, 0) + cost_function([1, 3, 3, 0])},
        # Prior 4
        {'N1': 1, 'N2': 0, 'N3': 2, 'N4': 0, 'target': black_box_function(1, 0, 2, 0) + cost_function([1, 0, 2, 0])},
        # Prior 5
    ]

    # 3
    priors3 = [
        {'N1': 3, 'N2': 3, 'N3': 2, 'N4': 1, 'target': black_box_function(3, 3, 2, 1) + cost_function([3, 3, 2, 1])},
        # Prior 1
        {'N1': 1, 'N2': 0, 'N3': 0, 'N4': 3, 'target': black_box_function(1, 0, 0, 3) + cost_function([1, 0, 0, 3])},
        # Prior 2
        {'N1': 0, 'N2': 2, 'N3': 3, 'N4': 0, 'target': black_box_function(0, 2, 3, 0) + cost_function([0, 2, 3, 0])},
        # Prior 3
        {'N1': 2, 'N2': 1, 'N3': 1, 'N4': 2, 'target': black_box_function(2, 1, 1, 2) + cost_function([2, 1, 1, 2])},
        # Prior 4
        {'N1': 2, 'N2': 2, 'N3': 0, 'N4': 2, 'target': black_box_function(2, 2, 0, 2) + cost_function([2, 2, 0, 2])},
        # Prior 5
    ]

    # 4
    priors4 = [
        {'N1': 1, 'N2': 3, 'N3': 1, 'N4': 2, 'target': black_box_function(1, 3, 1, 2) + cost_function([1, 3, 1, 2])},
        # Prior 1
        {'N1': 2, 'N2': 0, 'N3': 2, 'N4': 1, 'target': black_box_function(2, 0, 2, 1) + cost_function([2, 0, 2, 1])},
        # Prior 2
        {'N1': 3, 'N2': 2, 'N3': 0, 'N4': 3, 'target': black_box_function(3, 2, 0, 3) + cost_function([3, 2, 0, 3])},
        # Prior 3
        {'N1': 0, 'N2': 1, 'N3': 3, 'N4': 0, 'target': black_box_function(0, 1, 3, 0) + cost_function([0, 1, 3, 0])},
        # Prior 4
        {'N1': 0, 'N2': 2, 'N3': 2, 'N4': 0, 'target': black_box_function(0, 2, 2, 0) + cost_function([0, 2, 2, 0])},
        # Prior 5
    ]
    ...
    while count <= budget:
        ...
        print(best_cost)
        utility = float(best_performance) + float(best_cost)
    ...
    print("Best point suggestion : {}, value: {}, iteration: {}".format(best_crew, np.min(visited_utility),np.argmin(visited_utility) + 1))
